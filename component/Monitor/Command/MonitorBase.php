...
use Trensy\Component\Monitor\MonitorSerialization;
use Trensy\Component\Monitor\MonitorServer;
...
class MonitorBase
{
    ...
    protected static function start($config, $appName)
    {
        ...
        $performClass = $config['monitorReceive'];
        if(!$performClass){
            Log::sysinfo("monitor.monitorReceive config not config");
            return ;
        }
